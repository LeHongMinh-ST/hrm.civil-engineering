        ...
        <div class="page-header-content d-lg-flex">
            <div class="d-flex">
                <h4 class="page-title mb-0">
                    Thợ(Nhân công) - <span class="fw-normal">Cập nhật #{{$worker->id}}</span>
                </h4>
            </div>
...
@section('page-content')
    <div class="content">
        <!-- Content -->
        <form action="{{ route('workers.update', ['worker' => $worker->id, ...request()->query()]) }}" id="worker-form" method="post">
            @method('put')
            @csrf
            <div class="row">
                                        ...
                                        <div class="card-img-actions d-inline-block mb-3">
                                            <div id="holder" class="image-preview">
                                                <img class="img-fluid" id="holder"
                                                     src="{{ $worker->thumbnail ?? asset(config('constants.user_image_default')) }}"
                                ...
                                <div class="col-12 col-md-9">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                               value="{{ old('name', $worker->name) }}" id="name-input" name="name">
                                        @error('name')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('dob', $worker->dob) }}" id="dob-input" name="dob">
                                        </div>
                                        @error('dob')
                                        <div id="error-name" class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group  mb-3">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                               value="{{ old('phone', $worker->phone) }}" id="phone-input" name="phone">
                                        @error('phone')
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group  mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('citizen_identification',  $worker->citizen_identification) }}"
                                ...
                                <div class="col-12">
                                    <div class="form-group  mb-3">
                                        ...
                                        <textarea type="text"
                                                  ...
                                                  id="address-input"
                                                  name="address">{{ old('address', $worker->address) }}</textarea>
                                        @error('phone')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('coefficients_salary', $worker->coefficients_salary) }}"
                ...
                <div class="col-12 col-xl-3">
                    <div class="card">
                        <div class="card-header">
                            <div class="title bold"><i class="ph-gear me-1"></i> Tình trạng</div>
                        </div>
                        <div class="card-body">
